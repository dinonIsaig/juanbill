...
<div class="bg-white border-b border-gray-200 p-6 flex items-center justify-between">
    ...
    <div class="flex items-center gap-6 ml-8">
        ...
        <button class="relative text-neutral-gray hover:text-admin transition">
        ...
        <div class="flex items-center gap-2">
            <div class="w-10 h-10 bg-secondary rounded-full flex items-center justify-center text-admin font-bold">
