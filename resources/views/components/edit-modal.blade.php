                ...
                <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input 
                                    type="text" 
                                    placeholder="Unit No." 
                                    class="block w-full appearance-none rounded-md border border-gray-200 bg-gray-50 py-2.5 px-3 text-gray-500 shadow-sm focus:border-overdue-text focus:outline-none focus:ring-1 focus:ring-overdue-text sm:text-sm placeholder-gray-400"
                                >
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select id="status" class="bg-none block w-full appearance-none rounded-md border border-gray-200 bg-gray-50 py-2.5 px-3 text-gray-500 shadow-sm focus:border-overdue-text focus:outline-none focus:ring-1 focus:ring-overdue-text sm:text-sm">
