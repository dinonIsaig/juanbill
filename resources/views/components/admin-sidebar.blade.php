<div id="sidebar" style="visibility: hidden;"
    class="admin-sidebar bg-gradient-to-b from-admin to-[#281011] text-white flex flex-col h-screen shrink-0 transition-all duration-300 ease-in-out w-auto shadow-xl overflow-hidden">
    ...
    <nav id="mainNav" class="flex-1 px-6 py-6 space-y-8 overflow-y-auto custom-scrollbar transition-all duration-200">
        ...
        <div>
            ...
            <ul class="space-y-3">
                <li>
                    <a href="{{ route('admin.dashboard') }}" class="sidebar-link group transition-all duration-200">
        ...
        <div>
            ...
            <ul class="space-y-3">
                <li>
                    <a href="{{ route('admin.electricity') }}" class="sidebar-link group transition-all duration-200">
                ...
                <li>
                    <a href="{{ route('admin.water') }}" class="sidebar-link group transition-all duration-200">
                ...
                <li>
                    <a href="{{ route('admin.rent') }}" class="sidebar-link group transition-all duration-200">
                ...
                <li>
                    <a href="{{ route('admin.association') }}" class="sidebar-link group transition-all duration-200">
