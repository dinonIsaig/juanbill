...
@php
    $confirmModalId = 'onlinePaymentConfirm-' . $transactionID;
@endphp
            ...
            <div class="relative overflow-hidden rounded-lg shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-md">
                <div class=" bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4 ">
                    ...
                    <div class="flex flex-col gap-4 p-4 ">
                        <button onclick="document.getElementById('{{ $id }}').classList.add('hidden');document.getElementById('{{ $confirmModalId }}').classList.remove('hidden');" class="normal-btn">
                        Proceed
                        </button>
...
<x-online-payment-confirm id="{{ $confirmModalId }}" :transactionID="$transactionID" :amount='$amount' />
